...
public class AbilityDevCreateMage extends Ability{

	public AbilityDevCreateMage() {
	...
	public void applyAbility(Entity source, Entity target) {
		...
		GameInfo.getObjectMap().getEntityMap().add(new Mage(p, "DEV",  3, 1, true, new ArrayList<>()));
	}
