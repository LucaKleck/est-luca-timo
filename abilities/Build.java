...
public class Build extends Ability {
	...
	public void applyAbility(Entity source, Entity target) {
		...
		if(buildingType.equals(Building.BARRACKS)) {
			building = new ProductionBuilding(buildPoint, Building.BARRACKS, 10, 10, 1, true, new ArrayList<>());
		...
		if(buildingType.equals(Building.STONE_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.STONE_GETTER, 10, 10, 1, true, new ArrayList<>());		
		}
		if(buildingType.equals(Building.FOOD_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.FOOD_GETTER, 10, 10, 1, true, new ArrayList<>());		
		}
		if(buildingType.equals(Building.GOLD_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.GOLD_GETTER, 10, 10, 1, true, new ArrayList<>());		
		}
		if(buildingType.equals(Building.METAL_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.METAL_GETTER, 10, 10, 1, true, new ArrayList<>());		
		}
		if(buildingType.equals(Building.MANA_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.MANA_GETTER, 10, 10, 1, true, new ArrayList<>());		
		}
		//Defense Building
		if(buildingType.equals(Building.WALL)) {
			building = new DefenseBuilding(buildPoint, Building.WALL, 20, 20, 1, true, new ArrayList<>());		
		}
		if(buildingType.equals(Building.ARCHER_TOWER)) {
			building = new DefenseBuilding(buildPoint, Building.ARCHER_TOWER, 10, 10, 1, true, new ArrayList<>());		
		}
