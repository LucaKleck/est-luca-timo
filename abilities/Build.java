...
public class Build extends Ability {
	...
	public void applyAbility(Entity source, Entity target) {
		...
		if (buildingType.equals(Building.TOWN_CENTER)) {
			building = new ProductionBuilding(buildPoint, Building.TOWN_CENTER, 15, 15, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.SIEGE_WORKSHOP)) {
			building = new ProductionBuilding(buildPoint, Building.SIEGE_WORKSHOP, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		// Resource Building
		if (buildingType.equals(Building.WOOD_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.WOOD_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.STONE_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.STONE_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.FOOD_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.FOOD_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.GOLD_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.GOLD_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.METAL_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.METAL_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		if (buildingType.equals(Building.MANA_GETTER)) {
			building = new ResourceBuilding(buildPoint, Building.MANA_GETTER, 10, 10, 1, controlable,
					new ArrayList<>());
		}
		// Defense Building
