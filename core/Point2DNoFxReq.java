...
public class Point2DNoFxReq {
     ...
     *          constructed <code>Point2D</code>
     */
    public Point2DNoFxReq(float x, float y) {
        this.x = x;
        this.y = y;
    }
     ...
     */
    public void setLocation(Point2DNoFxReq p) {
        setLocation(p.x, p.y);
    }
     ...
     * <code>Point2D</code> to a specified <code>Point2D</code>.
     */
    public float distanceSq(Point2DNoFxReq pt) {
     ...
     */
    public float distance(Point2DNoFxReq pt) {
        float px = pt.x - this.x;
        float py = pt.y - this.y;
        return (float) Math.sqrt(px * px + py * py);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof Point2DNoFxReq) {
            Point2DNoFxReq p2d = (Point2DNoFxReq) obj;
